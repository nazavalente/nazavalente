# Hi 👋, I'm Nazario Jose Valente da Cruz
...
- 🎓 Final-year Computer Science student at **Telkom University**, Bandung
- 🛠️ Currently building an **assets feature** for an SSO backend service (**Go / Fiber v2 / PostgreSQL**)
- 📊 Working on my thesis (skripsi): **Multi-Horizon Forecasting of Net Asset Value across Mutual Fund types**, comparing **Temporal Fusion Transformer (TFT)** vs **GRU**
- 🌱 Currently deepening my knowledge of **backend architecture, JWT auth flows, and deep learning for time series**
- 💬 Ask me about **Go, REST APIs, PostgreSQL, Python, and forecasting models**
- ⚡ Fun fact: I enjoy untangling bugs almost as much as I enjoy tuning a model's hyperparameters
...
- Designing PostgreSQL migrations & JWT-protected REST endpoints for an SSO service
- Comparing TFT and GRU architectures for daily/weekly/monthly NAV forecasting
- Sharpening my understanding of external macro features (JCI, inflation, BI rate, exchange rate) in time-series models
...
nazariojosev@student.telkomuniversity.ac.id
